...
Data.Quests = {
	...
	[627] = {
		...
		[39861] = "Tying Up Loose Ends|10+ 39718 -40122|70.51 44.08|Archmage Khadgar",
	...
	[747] = {
		-- Figure out prereqs for the Scouting Map
		-- Scouting Map
		[39718] = "Paradise Lost|10+ druid -38834 -44137|52.52 50.85|Scouting Map|warboard",
		[39731] = "The Tranquil Forest|10+ druid -40122|52.52 50.85|Scouting Map|warboard",
		[39733] = "The Lone Mountain|10+ druid -38907 -38911|52.52 50.85|Scouting Map|warboard",
	...
	[739] = {
		...
		-- Scouting Map
		[39718] = "Paradise Lost|10+ hunter +40959 -38834 -44137|42.48 46.65|Scouting Map|warboard",
		[39731] = "The Tranquil Forest|10+ hunter +40959 -40122|42.48 46.65|Scouting Map|warboard",
		[39733] = "The Lone Mountain|10+ hunter +40959 -38907 -38911|42.48 46.65|Scouting Map|warboard",
	...
	[709] = {
		-- Figure out prereqs for the Scouting Map
		-- Scouting Map
		[39718] = "Paradise Lost|10+ monk -38834 -44137|52.91 60.2|Scouting Map|warboard",
		[39731] = "The Tranquil Forest|10+ monk -40122|52.91 60.2|Scouting Map|warboard",
		[39733] = "The Lone Mountain|10+ monk -38907 -38911|52.91 60.2|Scouting Map|warboard",
	...
	[24] = {
		-- Figure out prereqs for the Scouting Map
		-- Scouting Map
		[39718] = "Paradise Lost|10+ paladin -38834 -44137|53.43 78.64|Scouting Map|warboard",
		[39731] = "The Tranquil Forest|10+ paladin -40122|53.43 78.64|Scouting Map|warboard",
		[39733] = "The Lone Mountain|10+ paladin -38907 -38911|53.43 78.64|Scouting Map|warboard",
	...
	[630] = {
		-- Behind Legion Lines
		[39718] = "Paradise Lost|10+ -38834 -44137|15 20|Scouting Map|info link:$order_hall_map_id|Use the {warboard}$scouting_map_in_order_hall to start the Azsuna story",
			[41220] = "Down to Azsuna|10+ 39718 -38834 -44137|15 20|Archmage Khadgar|info link:627|Visit {!}Archmage Khadgar in Krasus' Landing to continue the Azsuna story",
		...
		-- Ruins of Nar'thalas
		-- Check if these have any prereqs at all (maybe 37256 or 37257 or +37497)
		...
		-- Challiane Vineyards
		[38203] = {
			"Challiane Vineyards|10+|43.88 12.51|Cellarman Voodani",
			"Challiane Vineyards|10+|40.8 9.2|Cellarman Voodani",
		},
	...
	[641] = {
		-- Nature's Call
		[39731] = "The Tranquil Forest|10+ -40122|15 20|Scouting Map|info link:$order_hall_map_id|Use the {warboard}$scouting_map_in_order_hall to start the Val'sharah story",
			[39861] = "Tying Up Loose Ends|10+ 39731 -40122|15 20|Archmage Khadgar|info link:627|Visit {!}Archmage Khadgar in Krasus' Landing to continue the Val'sharah story",
				[40122] = "Cenarius, Keeper of the Grove|10+ 39861|54.69 72.84|Malfurion Stormrage",
	...
	[650] = {
		-- The Rivermane Tribe
		[39733] = "The Lone Mountain|10+ -38907 -38911|15 20|Scouting Map|info link:$order_hall_map_id|Use the {warboard}$scouting_map_in_order_hall to start the Highmountain story",
			[38907] = "Keepers of the Hammer|10+ 39733 -38911|15 20|Warbrave Oro|info link:627|Visit {!}Warbrave Oro in Krasus' Landing to continue the Highmountain story",
					...
					[39490] = "Infestation|10+ 38911|43.69 59.9|Farmer Maya",
						[39323] = "Moozy's Sojourn|10+ 39491 39272 39490|40.25 64.06|Rordan Waterwise",
							[39572] = "Moozy's Adventure|10+ 39323|37.47 64.3|Moozy Waterwise",
								[42590] = "Moozy's Reunion|10+ 39572|46.91 61.66|Sella Waterwise|link:750", -- CHECK HOW EARLY YOU CAN GET THIS
		...
		[39859] = "Note-Eating Goats|10+ 40217,40170|39.92 52.23|Addie Fizzlebog",
		[40170] = "Amateur Hour|10+ 40217,39859 ~40217 ~39417|40.03 52.24|Hemet Nesingwary",
		...
		-- Icepine Point
		[39670] = "Critter Scatter Shot|10+ 39386|57.63 56.61|Razik Gazbolt",
		...
		[40000] = "A True Hunter|10+ 39386,+39670|57.59 56.41|Lorna Stoutfoot",
	...
	[750] = {
		-- The Rivermane Tribe
		[39733] = "The Lone Mountain|10+ -38907 -38911|15 20|Scouting Map|info link:$order_hall_map_id|Use the {warboard}$scouting_map_in_order_hall to start the Highmountain story",
			[38907] = "Keepers of the Hammer|10+ 39733|15 20|Warbrave Oro|info link:627|Visit {!}Warbrave Oro in Krasus' Landing to continue the Highmountain story",
				[42590] = "Moozy's Reunion|10+ 39572|45.89 54.92 49.74 53.59|Sella Waterwise|inside", -- CHECK HOW EARLY YOU CAN GET THIS
	...
	[652] = {
		...
		[39733] = "The Lone Mountain|10+ -38907 -38911|15 20|Scouting Map|info link:$order_hall_map_id|Use the {warboard}$scouting_map_in_order_hall to start the Highmountain story",
			[38907] = "Keepers of the Hammer|10+ 39733|15 20|Warbrave Oro|info link:627|Visit {!}Warbrave Oro in Krasus' Landing to continue the Highmountain story",
				[42590] = "Moozy's Reunion|10+ 39572|57.96 75.66|Sella Waterwise|up link:750", -- CHECK HOW EARLY YOU CAN GET THIS
	...
	[634] = {
		...
		[44701] = "Stormheim|10+ -39864 -38307 horde|30.27 40.56|Archmage Landon", -- Horde
			[38035] = "A Royal Summons|10+ 39735,44700 alliance|30.27 40.56|Sky Admiral Rogers|elsewhere link:627|Visit {!}Sky Admiral Rogers in the Violet Citadel to continue the Stormheim story", -- Alliance
			[38307] = "The Warchief Beckons|10+ 39864,44701 horde|30.27 40.56|Nathanos Blightcaller|elsewhere link:627|Visit {!}Nathanos Blightcaller in the Violet Citadel to continue the Stormheim story", -- Horde
				[38206] = "Making the Rounds|10+ 38035 alliance|30.27 40.56|Sky Admiral Rogers|elsewhere link:627|Visit {!}Sky Admiral Rogers in the Violet Citadel to continue the Stormheim story", -- Alliance
				[39698] = "Making the Rounds|10+ 38307 horde|30.27 40.56|Lady Sylvanas Windrunner|elsewhere link:1|Visit {!}Lady Sylvanas Windrunner in Bladefist Bay to continue the Stormheim story", -- Horde
					[39800] = "Greymane's Gambit|10+ 38206 alliance|30.27 40.56|Genn Greymane|elsewhere link:84|Visit {!}Genn Greymane aboard the Skyfire in Stormwind Harbor to continue the Stormheim story", -- Alliance
					[39801] = "The Splintered Fleet|10+ 39698 horde|30.27 40.56|Lady Sylvanas Windrunner|elsewhere link:1|Visit {!}Lady Sylvanas Windrunner in Bladefist Bay to continue the Stormheim story", -- Horde
		...
		[38459] = "The Ancient Trials|10+ 38362 horde|36.8 31.02|Huginn", -- Horde
			-- Havi's location changes depending on faction
			[38331] = {"Havi's Test|10+ 38210 alliance|43.17 49.15|Havi", "Havi's Test|10+ 38459 horde|41.83 43.06|Havi",},
		...
		-- Deemed Worthy
		-- Check if this requires Uniting the Isles
	...
	[680] = {
		-- Magic Message
		[39985] = "Khadgar's Discovery|45+ -39986 -44555|15 20|Archmage Khadgar|info link:627|Visit {!}Archmage Khadgar in the Violet Citadel to start the Suramar story", -- There are two versions of this quest that get marked as completed at the same time
			[39986] = "Magic Message|45+ 39985,44555|15 20|Archmage Khadgar|info link:627|Visit {!}Archmage Khadgar in the Violet Citadel to continue the Suramar story",
				[39987] = "Trail of Echoes|45+ 39986|15 20|Archmage Khadgar|info link:627|Visit {!}Archmage Khadgar in the Violet Citadel to continue the Suramar story",
	...
	[646] = {
		-- Armies of Legionfall
		[45727] = "Uniting the Isles|45+ -43341|23 20|Archmage Khadgar|info link:627|Visit {!}Archmage Khadgar in the Violet Citadel to start the Broken Shore story",
			[46730] = "Armies of Legionfall|45+ 45727|23 20|Archmage Khadgar|info link:627|Visit {!}Archmage Khadgar in Krasus' Landing to start the Broken Shore story",
		
		-- Assault on Broken Shore
		[46734] = "Assault on Broken Shore|45+ 46730|23 20|Archmage Khadgar|info link:627|Visit {!}Archmage Khadgar in Krasus' Landing to continue the Broken Shore story",
	...
	[97] = {
		...
		[9616] = {
			...
			-- As of 9.0 the drop is broken outside Chromie Time and will not drop at all for level 50+ characters, not even in Party Sync
